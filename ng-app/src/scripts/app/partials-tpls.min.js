...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/classification/accuracy/lift.html',
    '<div class=\'columns small-2\'><ul class=\'no-bullet time-list\'><li class=\'reversed run\' data-index=\'{{$index}}\' ng-repeat=\'l in lift.lift\'> <input id=\'ts{{$index}}\' ng-model=\'l.selected\' type=\'checkbox\'> <label class=\'timestamp\' for=\'ts{{$index}}\'>{{l.timestamp | date:\'dd.MM.yyyy H:mm\'}}</label></li></ul></div><div class=\'columns small-10 chart-container\'><div class=\'chart line-chart\'><lift-chart chart=\'lift.lift\'></lift-chart></div></div>');
}]);
})();
