...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/augur-performance-learning.html',
    '<div class=\'row augur-performance\'><div class=\'columns small-12\'><div class=\'heading\'><h1>Performance drift (Learning)</h1><h6 class=\'subheader\'>Changes in the learning data runs over the last 30 days</h6></div><d3-performance-chart data=\'data\'></d3-performance-chart></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('partials/augur-settings.html',
    'I am the settings {{ augur.id }} {{ augur }}');
}]);
})();
